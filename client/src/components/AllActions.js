...
class OfficialArraytoList extends React.Component {
    ...
    render()
    {
        ...
        var officialList = officialArray.map(
            function (officialArrayObj) {
                return (
                <li> {officialArrayObj} </li>
                );
            }
        );
...
class OfficialActions extends React.Component
{
    render()
    {
        return(
            <Row>
                <Col>
                    <OfficialArraytoList uneligibleOfficials = {this.props.uneligibleOfficials}/>
                </Col>
                <Col>
                    <OfficialForm 
