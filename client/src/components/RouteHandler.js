...
{  
    ...
    async getGeneralDetails()
    {
          ...
          try {
            ...
            var _roleId = await instance.methods.getRole(accounts[0]).call({ from: accounts[0]});
            this.setState(
              {
                roleId : _roleId
              }
            ...
            alert(
              `Error while collecting General details`
            );
            console.error(error);
          }
    ...
    componentWillMount() {
      this.getGeneralDetails().then(
        () =>
        {
          ...
          else if(this.isGovernmentOfficial() && this.props.request === "OfficialProfile")
          {
              ...
              else 
              {
                ...
                {  
                  ...
                  return <FarmerProfile 
                          ...
                          stateOfResidence = {this.state.data._details._details._stateOfResidence}
                          ...
                          policyDescriptions = {this.state.data._policyDescriptions._policyDescriptions}
                          />
                }
                else
                { 
